...
int main(int argc, char* argv[]) {
    ...
    // Descomenta solo el bloque que quieras probar
    /*
    {
        Location loc;
    ...
    */
    ...
    /*
    {
        ...
        CHECK("T01-24 VectorLocation_VectorLocation_def3", vloc._size, 100);
    }
    */
    ...
    */
    ...
    /*
    {
        ...
        VectorLocation vloc(2);
        vloc._locations[0] = loc1;   // acceso directo — necesita -DTESTING
    ...
    */
    ...
    /*
    {
        ...
        VectorLocation l1(n);
        for (int i = 0; i < n; i++) { l1._locations[i].set(i,i,std::to_string(i)); }
    ...
    */
    ...
    /*
    {
        int n = 5; Location loc1; loc1.set(0.0,0.0,"1");
        VectorLocation l1(n);
        for (int i = 0; i < n; i++) { l1._locations[n-(i+1)].set(i,i,std::to_string(i)); }
    ...
    */
    ...
    /*
    {
        ...
        const char* fileName = "tests/output/test_save1.loc";
    ...
    */
    ...
    {
        VectorInt v;
        CHECK("T01-48 VectorInt_def0", v._size, 0);
    }
    */
    ...
    {
        VectorInt v(5);
        CHECK("T01-49 VectorInt_def1", v._size, 5);
    }
    */
    ...
    */
    ...
    /*
    {
        ...
        CHECK("T01-52 VectorInt_append_0", v._size, 3);
    }
    */
    ...
    {
        VectorInt v(2); v.append(7);
        CHECK("T01-53 VectorInt_append_1", v._values[2], 7);
    }
    */
    ...
    */
    ...
    {
        VectorInt v1(3), v2(3);
        for (int i = 0; i < 3; i++) { v1._values[i] = 5; v2._values[i] = 5; }
        v2._values[0] = 1;
    ...
    */
    ...
    {
        Clustering clt;
        double r = clt._clusters.getSize() + clt._isDone + clt._K + clt._numIterations + clt._sumWCV;
    ...
    */
    ...
    /*
    {
        ...
        ArrayClustering arrayClt; InitializeArrayClustering(arrayClt, 3);
        AppendArrayClustering(arrayClt, clt1);
        AppendArrayClustering(arrayClt, clt1);  // segunda vez: no debe añadir (isEquivalentTo)
        string result = inspectT(arrayClt);
        DeallocateArrayClustering(arrayClt);
        string expected = "capacity: 3 size: 1 List of Clusters: K=2 Sum of within-cluster variances: 1.300000 Number of iterations: 11 Cluster number for each location: 3 0 0 0 Centroids: 2 0.000000 0.000000 0.000000 0.000000 Cluster 0 information: 0 0.000000 0.000000 Location0 1 1.000000 1.000000 Location1 2 2.000000 2.000000 Location2 Cluster 1 information: ";
        CHECK("T01-85 ArrayClustering_append_1", result, expected);
    }
    */
    ...
    /*
    {
        ...
        clt1._numIterations = 11; clt1._sumWCV = 1.3; clt1._isDone = true;
        ArrayClustering arrayClt; InitializeArrayClustering(arrayClt);
        arrayClt.size = 2;  // simula que está lleno (capacity=2)
        AppendArrayClustering(arrayClt, clt1);  // debe hacer resize a 4
        string result = std::to_string(arrayClt.capacity) + " " + std::to_string(arrayClt.size);
        DeallocateArrayClustering(arrayClt);
    ...
    */
    ...
    // --- TEST 92: VectorLocation_out_of_range__append_4 ---
    /*
    {
        Location loc; loc.set(37.2, -3.6, "Granada");
        VectorLocation vloc;
        ...
        vloc.append(loc);  // ya está, no debe lanzar (nombre igual)
        CHECK("T02-92 VectorLocation_out_of_range_append_4", vloc._size, 100);
    }
    */

    // --- TEST 93: VectorLocation_out_of_range__append_5 (excepción) ---
    /*
    {
    ...
    */
    ...
    /*
    {
        ...
        int n = 1; VectorLocation l1(n);
        std::string sinStr = std::to_string(VectorLocation::DIM_VECTOR_LOCATIONS + 1);
        istringstream ssin(sinStr);
        try {
            l1.load(ssin);
            cout << "  => FALLO (no lanzó excepción)" << endl;
        } catch (const std::out_of_range& e) {
    ...
    */
    ...
    // --- TEST 96: VectorLocation_append_2 ---
    /*
    {
        Location loc; loc.set(37.2, -3.6, "Granada");
        VectorLocation vloc;
        vloc.append(loc); vloc.append(loc);  // segunda vez: duplicado, no añade
        string result = std::regex_replace(vloc.toString(), std::regex(ENDL), " ");
    ...
    */
    ...
    /*
    {
        ...
        for (int i = 1; i <= n; i++) { l1._locations[i-1].set(-i, i, std::to_string(i)); }
        l2 = l1.select(loc0, loc2);
        CHECK("T02-99 VectorLocation_select_0", l2._size, 0);
    }
    */
    ...
    /*
    {
        ...
        for (int i = 1; i <= sizeOriginal; i++) { l1._locations[i-1].set(i, i, std::to_string(i)); }
        l2 = l1.select(loc1, loc2);
        CHECK("T02-100 VectorLocation_select_1", l2._size, 5);
    }
    */
    ...
    /*
    {
        ...
        for (int i = 0; i <= n; i++) { l1._locations[i].set(i*(n+1), i*(n+1), std::to_string(i)); }
        l2 = l1.select(loc0, loc2);
        CHECK("T02-101 VectorLocation_select_2", l2._size, 1);
    }
    */
    ...
    */
    ...
    /*
    {
        ...
        for (int i = 0; i < sizeOriginal; i++) {
            loc.setName(std::to_string(i));
            l1.at(sizeOriginal-(i+1)) = loc; sol.append(loc);
        }
        l1.sort();
    ...
    */
    ...
    /*
    {
        ...
        VectorLocation l2(n); l2.assign(loc);
        string result = l2.toString();
        // regex replace newlines
        result = std::regex_replace(result, std::regex(ENDL), " ");
    ...
    */
    ...
    /*
    {
        ...
        VectorLocation l2(n);
        for (int i = 0; i < 5; i++) { l2._locations[i] = loc1; }
        l2.assign(loc0);
        string result = std::regex_replace(l2.toString(), std::regex(ENDL), " ");
    ...
    */
    ...
    /*
    {
        ...
        string ss = std::string("1 ") + string(LOCATION_OTHER) + " ";
        istringstream ssin(ss);
        l1.load(ssin); ssin.clear(); ssin.str(ss); l1.load(ssin);
        string result = std::regex_replace(l1.toString(), std::regex(ENDL), " ");
        CHECK("T02-111 VectorLocation_loadLoad_2", result,
              string("1 37.200000 -3.600000 Granada "));
    }
    */
    ...
    */
    ...
    // --- TEST 119: VectorInt__distance_fail2 (excepción) ---
    /*
    {
    ...
    */
    ...
    {
        int n = 5;
        ArrayClustering arrayClt, arrayCltResult;
        InitializeArrayClustering(arrayClt, n); InitializeArrayClustering(arrayCltResult, n);
        arrayClt.size = n; arrayCltResult.size = n;
        for (int i = 0; i < n; i++) {
            ...
            arrayCltResult.clustering[i]._K = 2;
            arrayCltResult.clustering[i]._sumWCV = 1.0 + i;
            arrayCltResult.clustering[i]._numIterations = 10;
            arrayCltResult.clustering[i]._isDone = true;
        }
        SortArrayClustering(arrayClt);
        string result = inspectT(arrayClt);
        DeallocateArrayClustering(arrayClt); DeallocateArrayClustering(arrayCltResult);
        string expected = "capacity: 5 size: 5 List of Clusters: "
            "K=2 Sum of within-cluster variances: 1.000000 Number of iterations: 10 Cluster number for each location: 0 Centroids: 0 Cluster 0 information: Cluster 1 information: "
            "K=2 Sum of within-cluster variances: 2.000000 Number of iterations: 10 Cluster number for each location: 0 Centroids: 0 Cluster 0 information: Cluster 1 information: "
            "K=2 Sum of within-cluster variances: 3.000000 Number of iterations: 10 Cluster number for each location: 0 Centroids: 0 Cluster 0 information: Cluster 1 information: "
    ...
    */
    ...
    /*
    {
        ...
        for (int i = 0; i < n; i++) {
            ...
            arrayClt.clustering[n-i-1]._isDone = true;
            arrayCltResult.clustering[i]._K = 2;
            arrayCltResult.clustering[i]._sumWCV = 1.0;
            arrayCltResult.clustering[i]._numIterations = 10 + i;
            arrayCltResult.clustering[i]._isDone = true;
        }
        SortArrayClustering(arrayClt);
        string result = inspectT(arrayClt);
