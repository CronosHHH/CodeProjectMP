...
LO PRIMERO DE TODO HAZ :  Ctrl+Shift+V
...
Los scripts se encuentran en la carpeta `/home/renato/Desktop/CodeProjectMP/Scripts/`.

### Requisitos previos

Antes de ejecutar cualquier script, asegúrate de que:
1. El directorio de trabajo es `/home/renato/Desktop/CodeProjectMP/Scripts/`
2. Los scripts tienen permisos de ejecución

Si es necesario darles permisos:

```bash
cd /home/renato/Desktop/CodeProjectMP/Scripts
chmod +x *.sh
```
...
```bash
# 1. Pos tu en la carpeta Fraud2
cd /home/renato/Desktop/CodeProjectMP/Fraud2
